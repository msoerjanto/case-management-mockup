...
export function Calendar() {
  ...
  const scheduleData = teamMembers.map(member => ({
    id: member.id,
    name: member.name,
    schedule: [
  ...
  return (
    <div className="bg-white rounded-lg border">
      <div className="border-b p-4">
        <h2 className="text-lg font-medium">{currentMonth} {currentYear} Schedule</h2>
      </div>
      
      <div className="p-4">
        <div className="text-sm text-gray-500 mb-4">
          Showing schedule for {scheduleData.length} team members
        </div>
